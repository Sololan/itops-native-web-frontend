    ...
    <yj-drawer v-model="visible" title="修改个人信息" @open="handleDrawerOpen" @close="handleDrawerClose">
        <el-form ref="infoFormData" :model="infoFormData" :rules="infoFormRules"
            ...
            <el-form-item label="用户名" prop="username">
                <el-input class="drawer-input" v-model="infoFormData.username"
                          placeholder="请输入" :disabled="true"/>
            </el-form-item>
            <el-form-item label="姓名" prop="fullName">
                <el-input class="drawer-input" v-model="infoFormData.fullName"
                          placeholder="请输入"/>
            </el-form-item>
            <el-form-item label="联系电话" prop="phone">
                <el-input class="drawer-input" v-model="infoFormData.phone"/>
            </el-form-item>
            ...
            <el-form-item>
                <el-input class="drawer-input input-line" :disabled="true"
                          v-model="infoFormData.wx"/>
                <el-button class="button-line" type="primary">解除绑定</el-button>
            </el-form-item>
            <el-form-item>
...
<script lang="ts">
    ...
    export default class InfoEditDrawer extends Vue {
